        ...
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{
            ...
            <div style={{
              ...
              flexShrink: 0,
              animation: 'popIn 0.5s 0.1s cubic-bezier(0.2, 0.9, 0.2, 1) both'
            }}>
              <svg width="38" height="38" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.8" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ color: '#666', fontSize: '0.9rem', lineHeight: 1.5 }}>
                Compra de <b style={{ color: '#111' }}>R$ {total.toFixed(2)}</b> via <b style={{ color: '#C8102E' }}>{paid}</b> processada com sucesso.
              </p>
            </div>
        ...
        <div style={{ flex: 1, border: '2px solid #222', borderRadius: 12, overflow: 'hidden', background: 'white' }}>
          {items.map((item, i) => (
            <div key={i} style={{ display: 'flex', alignItems: 'center', padding: '18px 20px', borderBottom: '1px solid #eee', gap: 12 }}>
              ...
              <span style={{ background: '#f0f0f0', borderRadius: 8, padding: '6px 14px', fontWeight: 700, color: '#222', fontSize: '0.95rem', minWidth: 110, textAlign: 'center' }}>
                R${item.price.toFixed(2)} und
              </span>
            </div>
          ))}
